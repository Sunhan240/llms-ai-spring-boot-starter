 ...
 *
 * @author John Blum
 * @see <a href="https://platform.openai.com/docs/guides/rate-limits/rate-limits-in-headers">Rate
 * limits in headers</a>
 * @since 0.7.0
 */
public class OpenAiRateLimit implements RateLimit {
    ...
    public String toString() {
        return String.format(RATE_LIMIT_STRING, getClass().getName(), getRequestsLimit(), getRequestsRemaining(),
