...
public interface PromptMetadata extends Iterable<PromptMetadata.PromptFilterMetadata> {
     ...
     *
     * @param promptIndex index of the {@link PromptFilterMetadata} contained in this {@link PromptMetadata}.
    ...
    interface PromptFilterMetadata {
         ...
         *
         * @param promptIndex           index of the prompt filter metadata contained in the AI response.
         * @param contentFilterMetadata underlying AI provider metadata for filtering applied to prompt content.
