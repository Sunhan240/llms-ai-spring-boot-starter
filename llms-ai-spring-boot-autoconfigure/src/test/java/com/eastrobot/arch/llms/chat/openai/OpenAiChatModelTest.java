...
//            llmsAiApi.setUri(properties.getUri());
    ...
    void stream1() {
        ...
        Flux<String> flux = chatModel.stream("美国大选目前的情况是怎样的");
        String join = String.join("", Objects.requireNonNull(flux.collectList().map(s -> {
